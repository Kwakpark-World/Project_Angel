    ...
    {            
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                output.uv.xy = v.uv.xy * fixed2(textLength / _Cols, 1.0 / _Rows);
                output.uv.zw = v.uv.zw;
                output.color = v.color;                
                output.customData1 = floor(v.customData1);
                output.customData2 = floor(v.customData2);
