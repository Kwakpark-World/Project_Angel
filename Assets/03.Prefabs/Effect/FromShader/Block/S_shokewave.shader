	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				#ifdef _USE_CEIL_ON
				float staticSwitch131 = (float2( 0,0 )).x;
				#else
				...
				float staticSwitch82 = saturate( ( saturate( ( uv_v148 * saturate( ( 1.0 - uv_v148 ) ) ) ) * 4.0 ) );
				#else
				float staticSwitch82 = saturate( staticSwitch81 );
				#endif
				...
				#endif
				float mask_ref153 = saturate( staticSwitch89 );
				#ifdef _USE_ADDMULITYMASK_ON
				float staticSwitch109 = saturate( ( saturate( ( main_r_ref144 + mask_ref153 ) ) * mask_ref153 ) );
				#else
				float staticSwitch109 = saturate( ( main_r_ref144 * mask_ref153 ) );
				#endif
				...
				float Alpha = saturate( ( vert_alpha_ref161 * saturate( ( saturate( ( _Opacity * saturate( ( saturate( ( tex2D( _Diss_Texture, panner54 ).r + staticSwitch62 ) ) * staticSwitch109 ) ) ) ) * saturate( distanceDepth69 ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( vert_alpha_ref161 * saturate( ( saturate( ( _Opacity * saturate( ( saturate( ( tex2D( _Diss_Texture, panner54 ).r + staticSwitch62 ) ) * staticSwitch109 ) ) ) ) * saturate( distanceDepth69 ) ) ) ) );
...
Node;AmplifyShaderEditor.CommentaryNode;15;-3822.011,795.829;Inherit;False;2183.075;973.5074;;27;153;87;86;151;85;84;83;152;89;13;12;81;82;11;45;149;10;137;9;79;138;150;148;8;183;188;190;Mask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;107;-294.9924,374.5667;Inherit;False;552.7916;168.0119;DepthFade;3;72;69;70;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SaturateNode;70;112.7989,424.567;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;46;-1042.989,256.0834;Inherit;True;Property;_Diss_Texture;Diss_Texture;15;0;Create;True;0;0;0;False;0;False;-1;None;d4fd20a809666dc4b8070b9bb5c369f8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-2590.028,-653.213;Inherit;False;Property;_Noise_Str;Noise_Str;12;0;Create;True;0;0;0;False;0;False;0.06793601;0;0;0.3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-1643.89,427.9514;Inherit;False;Property;_Diss_Tex_VPanner;Diss_Tex_VPanner;20;0;Create;True;0;0;0;False;0;False;0;0.72;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-2908.591,1664.94;Inherit;False;Property;_Mask_Pow;Mask_Pow;30;0;Create;True;0;0;0;False;0;False;5.346326;14.6;1;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1852.191,-93.89805;Inherit;False;Property;_Main_VPanner;Main_VPanner;6;0;Create;True;0;0;0;False;0;False;0.39;0.71;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1325.095,-384.5952;Inherit;True;Property;_Main_Texture;Main_Texture;3;0;Create;True;0;0;0;False;0;False;-1;None;acf4c38ea3cb21a489b76d3cd4225dad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;158;-843.8257,-288.2699;Inherit;False;F_Toon;-1;;1;;0;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-677.1745,-225.6922;Inherit;False;Property;_Main_Pow;Main_Pow;8;0;Create;True;0;0;0;False;0;False;1;2.23;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-620.7347,-119.791;Inherit;False;Property;_Main_Ins;Main_Ins;7;0;Create;True;0;0;0;False;0;False;1;2.75;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;38.90454,-316.5952;Inherit;False;Property;_TintColor;Tint Color;4;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;4,3.964907,2.283019,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-306.9396,208.5577;Inherit;False;Property;_Opacity;Opacity;9;0;Create;True;0;0;0;False;0;False;1;2.39;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DepthFade;69;-110.0442,423.5789;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;1606.308,-635.0662;Inherit;False;Property;_CullMode;CullMode;0;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;113;1329.353,-687.4009;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;1_fx/shokewave_r;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;2;5;True;_Src;10;True;_Dst;2;5;True;_Src;10;True;_Dst;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638387539112172886;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638387539142243526;  Use Shadow Threshold;0;0;Receive Shadows;0;638387539148933291;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;False;False;False;True;True;True;False;False;;False;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-267.9923,442.8524;Inherit;False;Property;_Fade_Distance;Fade_Distance;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;109;-627.9451,625.1513;Inherit;False;Property;_Use_AddMulityMask;Use_AddMulityMask;32;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;56;-303.3839,282.4914;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;181;-190.7364,280.9334;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;182;686.4155,189.8786;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;165;871.3641,-507.7634;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;9;-3485.313,1449.711;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;137;-3352.742,1449.668;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-3206.313,1344.711;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;149;-3680.637,1336.828;Inherit;False;148;uv_v;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;45;-3090.259,1347.171;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-2970.513,1349.711;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;4;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;183;-2851.446,1349.274;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;150;-3681.566,1173.691;Inherit;False;148;uv_v;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;138;-3342.649,1270.532;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;79;-3471.843,1271.01;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;81;-3183.242,1176.309;Inherit;False;Property;_Mask_1x;Mask_-1x;29;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;-961.0128,778.2266;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;157;-1013.794,907.9404;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;184;-847.9543,778.8239;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;185;-999.9543,631.8239;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;295.7404,257.8636;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;186;422.1008,259.2386;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;187;-1075.946,777.9907;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;147;-1349.577,769.162;Inherit;False;144;main_r_ref;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;155;-1344.21,836.6542;Inherit;False;153;mask_ref;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;108;-1183.195,775.9772;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;154;-1346.823,907.4286;Inherit;False;153;mask_ref;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-1170.678,626.9444;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;156;-1349.895,696.1734;Inherit;False;153;mask_ref;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;146;-1353.794,622.8394;Inherit;False;144;main_r_ref;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;188;-3004.741,1180.885;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;152;-2628.133,1264.927;Inherit;False;151;mask_pow_ref;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;190;-1904.444,1170.533;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;153;-1780.357,1166.49;Inherit;False;mask_ref;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;109;1;185;0
WireConnection;109;0;184;0
WireConnection;56;0;49;0
WireConnection;56;1;109;0
WireConnection;181;0;56;0
WireConnection;182;0;60;0
WireConnection;165;0;182;0
