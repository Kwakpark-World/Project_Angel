...
Shader "1_fx/Opaque"
{
	Properties
	{
		...
		_dissolve("dissolve", Range( -1 , 1)) = 0.04329046
		[Toggle(_USE_CUSTOM_ON)] _use_custom("use_custom", Float) = 0
		_main_color("main_color", Color) = (1,1,1,0)
		_threshold("threshold", Float) = 0
		_dissolve_outline_width("dissolve_outline_width", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult17 = (float2(_dissolve_upanner , _dissolve_vpanner));
				float2 texCoord13 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * appendResult17 + texCoord13);
				float4 tex2DNode12 = tex2D( _dissolve_tex, panner14 );
				float vert_w_ref21 = IN.ase_texcoord8.z;
				#ifdef _USE_CUSTOM_ON
				float staticSwitch23 = vert_w_ref21;
				#else
				float staticSwitch23 = _dissolve;
				#endif
				float temp_output_35_0 = step( 0.18 , ( tex2DNode12.r + staticSwitch23 ) );
				

				float3 BaseColor = ( ( _main_color * tex2D( _main_tex, texCoord28 ) ) + ( ( temp_output_35_0 - step( 0.18 , ( tex2DNode12.r + ( staticSwitch23 - _dissolve_outline_width ) ) ) ) * _Color0 ) ).rgb;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 panner14 = ( 1.0 * _Time.y * appendResult17 + texCoord13);
				float4 tex2DNode12 = tex2D( _dissolve_tex, panner14 );
				float vert_w_ref21 = IN.ase_texcoord2.z;
				#ifdef _USE_CUSTOM_ON
				float staticSwitch23 = vert_w_ref21;
				#else
				float staticSwitch23 = _dissolve;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner14 = ( 1.0 * _Time.y * appendResult17 + texCoord13);
				float4 tex2DNode12 = tex2D( _dissolve_tex, panner14 );
				float vert_w_ref21 = IN.ase_texcoord4.z;
				#ifdef _USE_CUSTOM_ON
				float staticSwitch23 = vert_w_ref21;
				#else
				float staticSwitch23 = _dissolve;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner14 = ( 1.0 * _Time.y * appendResult17 + texCoord13);
				float4 tex2DNode12 = tex2D( _dissolve_tex, panner14 );
				float vert_w_ref21 = IN.ase_texcoord.z;
				#ifdef _USE_CUSTOM_ON
				float staticSwitch23 = vert_w_ref21;
				#else
				float staticSwitch23 = _dissolve;
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;20;390.9753,44.87103;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;21;581.9753,112.871;Inherit;False;vert_w_ref;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;-459,-2;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;1_fx/Opaque;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;638496517597097817;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SamplerNode;11;-1449.486,-101.4761;Inherit;True;Property;_normal_tex;normal_tex;1;0;Create;True;0;0;0;False;0;False;-1;c4209b04f8d222c45acb912784553e02;b255991087aed72418fa56195a3bc228;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ComponentMaskNode;25;-1175.329,-102.5954;Inherit;True;True;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1201.329,84.40457;Inherit;False;Property;_normal_str;normal_str;7;0;Create;True;0;0;0;False;0;False;0;0.366;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;24;-1670.112,-81.63592;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;-1514.291,-290.5521;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-1301.424,-316.4552;Inherit;True;Property;_main_tex;main_tex;0;0;Create;True;0;0;0;False;0;False;-1;None;c3f89d34db70eb84aa6e492401c74c80;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;30;-1212.371,-480.5443;Inherit;False;Property;_main_color;main_color;8;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;31;-657.8381,443.19;Inherit;False;Property;_threshold;threshold;9;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;14;-3042.12,235.9617;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-3303.12,229.9617;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;17;-3222.12,350.9617;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-3438.12,344.9617;Inherit;False;Property;_dissolve_upanner;dissolve_upanner;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-3435.12,416.9617;Inherit;False;Property;_dissolve_vpanner;dissolve_vpanner;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-2877.848,206.9326;Inherit;True;Property;_dissolve_tex;dissolve_tex;2;0;Create;True;0;0;0;False;0;False;-1;d4fd20a809666dc4b8070b9bb5c369f8;22bef0cd2cde8d140b6668781f88f12c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;22;-2969.475,473.2328;Inherit;False;21;vert_w_ref;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-3063.874,399.3036;Inherit;False;Property;_dissolve;dissolve;5;0;Create;True;0;0;0;False;0;False;0.04329046;0.2606632;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;23;-2805.475,398.2328;Inherit;False;Property;_use_custom;use_custom;6;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;32;-2578.117,597.733;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;18;-2286.873,232.3036;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;34;-2281.117,488.733;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-2896.117,686.733;Inherit;False;Property;_dissolve_outline_width;dissolve_outline_width;10;0;Create;True;0;0;0;False;0;False;0;0.1411765;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;35;-1997.117,240.733;Inherit;True;2;0;FLOAT;0.18;False;1;FLOAT;0.3;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;36;-1987.117,498.733;Inherit;True;2;0;FLOAT;0.18;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;37;-1683.117,317.733;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;39;-1686.878,516.5674;Inherit;False;Property;_Color0;Color 0;11;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-883.3291,-98.59543;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-1225.635,374.1647;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-951.0922,-397.8938;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;40;-651.6882,15.36314;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=529B3984162EB0BA78C367C4E740B8230C743C15